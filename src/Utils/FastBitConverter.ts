/**
 * @see LiteNetLib.Utils.FastBitConverter
 */
export class FastBitConverter {
  /**
   * Writes a bigint to a buffer at a given index.
   * @see LiteNetLib.Utils.FastBitConverter.GetBytes(byte[] bytes, int startIndex, long value)
   *
   ...
   * @see LiteNetLib.Utils.FastBitConverter.WriteLittleEndian(byte[] buffer, int offset, ulong data)
   *
